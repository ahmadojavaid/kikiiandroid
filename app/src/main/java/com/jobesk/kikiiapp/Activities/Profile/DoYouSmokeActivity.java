...
public class DoYouSmokeActivity extends AppCompatActivity implements OnChipClickListener, View.OnClickListener {

    private static final String TAG = "DoYouSmokeActivity";
    private Context context= DoYouSmokeActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_do_you_smoke);
