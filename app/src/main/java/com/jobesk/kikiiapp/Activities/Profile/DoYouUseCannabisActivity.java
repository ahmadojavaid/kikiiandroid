...
public class DoYouUseCannabisActivity extends AppCompatActivity implements OnChipClickListener, View.OnClickListener {

    private static final String TAG = "DoYouUseCannabis";
    private Context context = DoYouUseCannabisActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_do_you_use_cannabis);
        ...
        findViewById(R.id.btn_save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constants.CANNABIS,isChecked);
    ...
    private void getIdentity() {
        ...
        callbackGetCategoryCall = api.getCategory(sessionManager.getAccessToken(), Constants.CANNABIS);
