...
public class PoliticalViewsActivity extends AppCompatActivity implements OnChipClickListener, View.OnClickListener {

    private static final String TAG = "PoliticalViews";
    private Context context = PoliticalViewsActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constants.POLITICAL_VIEWS,isChecked);
    ...
    private void getIdentity() {
        ...
        callbackGetCategoryCall = api.getCategory(sessionManager.getAccessToken(), Constants.POLITICAL_VIEWS);
        callbackGetCategoryCall.enqueue(new Callback<CallbackGetCategory>() {
            ...
            public void onResponse(Call<CallbackGetCategory> call, Response<CallbackGetCategory> response) {
                ...
                Log.d("cateGoriesHere1", "onResponse: " + new Gson().toJson(responseGetCategory));
