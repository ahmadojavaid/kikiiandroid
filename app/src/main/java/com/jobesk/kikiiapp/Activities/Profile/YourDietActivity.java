...
public class YourDietActivity extends AppCompatActivity implements OnChipClickListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constants.DIET_LIKE,isChecked);
    ...
    private void getIdentity() {
        ...
        callbackGetCategoryCall = api.getCategory(sessionManager.getAccessToken(), Constants.DIET_LIKE);
