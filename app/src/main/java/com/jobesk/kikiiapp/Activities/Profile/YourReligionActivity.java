...
public class YourReligionActivity extends AppCompatActivity implements OnChipClickListener, View.OnClickListener {

    private static final String TAG = "YourReligionActivity";
    private Context context = YourReligionActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_your_religion);
        ...
        findViewById(R.id.btn_save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constants.RELIGION, isChecked);
    ...
    private void getIdentity() {
        ...
        callbackGetCategoryCall = api.getCategory(sessionManager.getAccessToken(), Constants.RELIGION);
        callbackGetCategoryCall.enqueue(new Callback<CallbackGetCategory>() {
            ...
            public void onResponse(Call<CallbackGetCategory> call, Response<CallbackGetCategory> response) {
                Log.d("getReligion", "onResponse: " + new Gson().toJson(response.body()));
