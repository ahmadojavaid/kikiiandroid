...
public class InboxService implements ChildEventListener, ValueEventListener {
    private DatabaseReference mLanguagePreference1;
    public boolean isLoaded = false;


    public InboxService() {
        mLanguagePreference1 = FirebaseDatabase.getInstance("https://kikiiapp-default-rtdb.firebaseio.com/").getReference("Chats");
...
childUpdates1.put(senderId, postValues1);
        ...
        mLanguagePreference1.child(receiverId).push().setValue(postValues1, completionListener);
    }
