...
public class LastMessageService implements ChildEventListener, ValueEventListener {
    private DatabaseReference mLanguagePreference1, mLanguagePreference2;
    public boolean isLoaded = false;


    public LastMessageService(String senderId, String receiverId) {
        mLanguagePreference1 = FirebaseDatabase.getInstance("https://kikiiapp-default-rtdb.firebaseio.com/").getReference("LastMessages").child(senderId+"___"+receiverId);
        mLanguagePreference2 = FirebaseDatabase.getInstance("https://kikiiapp-default-rtdb.firebaseio.com/").getReference("LastMessages").child(receiverId+"___"+senderId);
    ...
    public LastMessageService(Query ref) {
        mQuery = ref;
...
//    }
    ...
    public void updateLastMessage(String message, String senderId, String receiverId, String type, String messageBy, DatabaseReference.CompletionListener completionListener) {
        ...
        mLanguagePreference2.setValue(postValues2, completionListener);
    }
    public void updateLastMessage(String message, long recordingTime, String senderId, String receiverId, String type, String messageBy, DatabaseReference.CompletionListener completionListener) {
        Message sender = new Message();
        Message receiver = new Message();
