    ...
    private final IRtcEngineEventHandler mRtcEventHandler = new IRtcEngineEventHandler() {
        ...
        public void onJoinChannelSuccess(String channel, final int uid, int elapsed) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.d(TAG, "run: " + "onJoinChannelSuccess");
//                    mLogView.logD("Join channel success, uid: " + (uid & 0xFFFFFFFFL));
        ...
        public void onFirstRemoteVideoDecoded(final int uid, int width, int height, int elapsed) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.d(TAG, "run: " + "onFirstRemoteVideoDecoded");
...
//                    mLogView.logI("User offline, uid: " + (uid & 0xFFFFFFFFL));
    ...
    String channelName, channeltoken, senderName, senderImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customLoader = new CustomLoader(VideoChatViewActivity.this, false);

        initUI();


        sessionManager = new SessionManager(VideoChatViewActivity.this);
...
//            application().loginRTCclient(channeltoken);
            ...
            mCallBtn.setImageResource(R.drawable.btn_answer_call);
        }
...
//        String token = getString(R.string.agora_access_token_video);
...
//        channelName = "7d72365eb983485397e3e3f9d460bdda";
        mRtcEngine.joinChannel(channeltoken, channelName, "Extra Optional Data", 0);
    }
